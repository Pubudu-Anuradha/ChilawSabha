...
--
-- Host: localhost
-- Generation Time: Feb 21, 2023 at 05:56 AM
...
CREATE TABLE `complaint` (
  ...
  `complainer's_name` int(11) NOT NULL,
...
--
-- Table structure for table `contact_us_numbers`
--

CREATE TABLE `contact_us_numbers` (
...
CREATE TABLE `library_member` (
  ...
  `no_of_books_requested` int(11) NOT NULL,
  `no_of_book_requests_accepted` int(11) NOT NULL,
  `added_by` int(11) NOT NULL,
  `added_time` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `users` (
  ...
  `reset_code_time` time DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `announcements`
  ADD KEY `announcement_post_id_fk` (`post_id`);
...
--
-- Indexes for table `contact_us_numbers`
--
ALTER TABLE `contact_us_numbers`
  ADD PRIMARY KEY (`contact_id`,`contact_no`);
...
ALTER TABLE `page_image`
  ADD PRIMARY KEY (`page`,`image`),
  ADD KEY `page_image_id_fk` (`image`);
...
ALTER TABLE `post_images`
  ADD PRIMARY KEY (`post_id`,`image_url`);
...
--
ALTER TABLE `complaint_handler`
  ADD CONSTRAINT `complaint_handler_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`);

--
-- Constraints for table `contact_us_numbers`
--
ALTER TABLE `contact_us_numbers`
  ADD CONSTRAINT `contact_us_contact_id_fk` FOREIGN KEY (`contact_id`) REFERENCES `contact_us_persons` (`contact_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `disabled_staff`
  ADD CONSTRAINT `disabled_staff_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`),
  ADD CONSTRAINT `staff_disabled_action_fk` FOREIGN KEY (`disabled_action`) REFERENCES `disabled_action` (`disabled_action_id`),
  ADD CONSTRAINT `staff_disabled_by_fk` FOREIGN KEY (`disabled_by`) REFERENCES `website_admin` (`user_id`),
  ADD CONSTRAINT `staff_disabled_re_enabled_by_fk` FOREIGN KEY (`re_enabled_by`) REFERENCES `website_admin` (`user_id`);

--
-- Constraints for table `edit_staff`
--
ALTER TABLE `edit_staff`
  ADD CONSTRAINT `edit_staff-by_fk` FOREIGN KEY (`edited_by`) REFERENCES `website_admin` (`user_id`),
  ADD CONSTRAINT `edit_staff_type_fk` FOREIGN KEY (`staff_type`) REFERENCES `staff_type` (`staff_type_id`),
  ADD CONSTRAINT `edit_staff_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`);
...
--
ALTER TABLE `library_member`
  ADD CONSTRAINT `library_member_added_by_fk` FOREIGN KEY (`added_by`) REFERENCES `library_staff` (`user_id`),
  ADD CONSTRAINT `library_member_state_fk` FOREIGN KEY (`member_state`) REFERENCES `member_state` (`member_state_id`),
  ADD CONSTRAINT `library_member_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `library_staff`
--
ALTER TABLE `library_staff`
  ADD CONSTRAINT `library_staff_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`);
...
--
ALTER TABLE `page_image`
  ADD CONSTRAINT `page_image_id_fk` FOREIGN KEY (`image`) REFERENCES `image` (`image_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `page_image_page_id_fk` FOREIGN KEY (`page`) REFERENCES `other_pages` (`page_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `post_contact`
  ADD CONSTRAINT `service_contact_post_id_fk` FOREIGN KEY (`post_id`) REFERENCES `post` (`post_id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `post_images`
--
ALTER TABLE `post_images`
  ADD CONSTRAINT `post_images_post_id_fk` FOREIGN KEY (`post_id`) REFERENCES `post` (`post_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `staff`
  ADD CONSTRAINT `staff_added_by_fk` FOREIGN KEY (`added_by`) REFERENCES `website_admin` (`user_id`),
  ADD CONSTRAINT `staff_state_fk` FOREIGN KEY (`staff_state`) REFERENCES `staff_states` (`staff_state_id`),
  ADD CONSTRAINT `staff_type_fk` FOREIGN KEY (`staff_type`) REFERENCES `staff_type` (`staff_type_id`),
  ADD CONSTRAINT `staff_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `storage_manager`
--
ALTER TABLE `storage_manager`
  ADD CONSTRAINT `storage_manager_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`);

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `user_type_fk` FOREIGN KEY (`user_type`) REFERENCES `user_type` (`user_type_id`);

--
-- Constraints for table `website_admin`
--
ALTER TABLE `website_admin`
  ADD CONSTRAINT `website_admin_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `staff` (`user_id`);
COMMIT;
