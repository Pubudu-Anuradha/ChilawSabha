                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btn-set">
                            <button class="btn favourite" onclick="window.location.href = '<?=URLROOT . '/LibraryStaff/Editbooks'?>'">Favourite</button>
                            <button class="btn planToRead">Plan to Read</button>
